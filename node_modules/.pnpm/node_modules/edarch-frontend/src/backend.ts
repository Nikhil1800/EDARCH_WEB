...
export class Backend implements backendInterface {
    ...
    async getMessage(arg0: Time, arg1: string): Promise<Message | null> {
        if (this.processError) {
            try {
    ...
    async getMessagesByEmail(arg0: string): Promise<Array<Message>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMessagesByEmail(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
